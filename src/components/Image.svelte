    ...
    <div class="opacity-0 group-hover:opacity-[.67] transition grid grid-cols-3 gap-y-4">
      <div title="Download">
        <svg xmlns="http://www.w3.org/2000/svg"
             class="cursor-pointer text-white hover:text-green-500 transition h-7 w-7" fill="none"
      ...
      <div title="Open">
        <svg xmlns="http://www.w3.org/2000/svg" class="cursor-pointer text-white hover:text-blue-400 transition h-7 w-7"
             fill="none"
      ...
      <div title="Report">
        <svg xmlns="http://www.w3.org/2000/svg" class="cursor-pointer text-white hover:text-red-500 transition h-7 w-7"
             fill="none"
